...
proc export data=damage.all_disaster
     outfile="D:\投稿\水稻坪割資料\data\災害資料\for_upload\crop_disaster_raw.csv"
     dbms=csv 
     replace;
run;

proc export data=damage.disaster_cleaned
     outfile="D:\投稿\水稻坪割資料\data\災害資料\for_upload\crop_disaster_cleaned.csv"
     dbms=csv 
     replace;
run;
